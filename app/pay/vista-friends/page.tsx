      ...
      >
        ...
        >
          ...
          <p className="mt-4 max-w-prose text-sm text-black/70">
            20 Session Training Block for Vista residents.
          </p>
        </div>
      </section>
            ...
            <article className="flex flex-col justify-between rounded-xl border border-black/10 bg-black/5 p-[var(--hp-card-pad)]">
              ...
              <div>
                ...
                <p className="mt-3 text-sm text-black/65">
                  A structured 20-session block designed for increased training frequency and consistent progression. Ideal for clients training multiple times per week.
                </p>
              </div>
