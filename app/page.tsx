        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/60 px-4">
          <div className="relative w-full max-w-3xl rounded-2xl bg-white p-4 shadow-xl">
            ...
            <p className="text-xs text-black/60 mb-3">
              Select a date and time using the calendar below, then review and agree
              to the Studio terms.
            </p>
            ...
            {showTerms && (
              <div className="mt-3 rounded-lg border border-black/10 bg-black/[0.02] p-3 space-y-2">
                ...
                <ul className="list-disc pl-5 text-xs text-black/70 space-y-1">
                  ...
                  <li>
                    You must inform your coach of any injuries, medical conditions,
                    medication or changes in your health before each session.
                  </li>
                  <li>
                    If you have any ongoing illnesses, recent surgery, chest pain,
                    shortness of breath, or other health concerns, you should consult
                    your GP or healthcare professional before starting personal
                    training.
                  </li>
                  <li>
                    You agree to follow studio safety instructions at all times and
                    to use equipment as demonstrated.
                  </li>
                  <li>
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center rounded-full bg-[#00C853] px-4 py-2 text-xs font-semibold text-black shadow hover:bg-[#00b648]"
                >
