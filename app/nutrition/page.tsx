...
export default function NutritionPage() {
  ...
  const [inputs, setInputs] = useState({
    ...
    goal: "", goal_weight: 0,
    activity_level: "", training_days: 0,
  });
  ...
  const handleSubmit = async () => {
    ...
    if (!inputs.weight || !inputs.goal || !inputs.sex || !inputs.activity_level) {
        alert("Please complete all sections in Step 1.");
        return;
    }
  ...
  return (
    <div className="p-6 space-y-6 max-w-xl mx-auto bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-black italic uppercase tracking-tighter text-black">Nutrition Assessment</h1>
      ...
      <div className="border p-6 space-y-4 rounded-2xl bg-white shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-xs font-bold uppercase text-gray-400 ml-1">Weight (kg)</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-bold uppercase text-gray-400 ml-1">Height (cm)</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-xs font-bold uppercase text-gray-400 ml-1">Age</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-bold uppercase text-gray-400 ml-1">Goal Weight (kg)</label>
            <input 
              placeholder="e.g. 75" 
              type="number" 
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-bold uppercase text-gray-400 ml-1">Gender</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-bold uppercase text-gray-400 ml-1">Fitness Goal</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-bold uppercase text-gray-400 ml-1">Activity Level</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-bold uppercase text-gray-400 ml-1">Days you are willing to train per week?</label>
          <input 
            type="number" 
            min="1" 
            max="7" 
      ...
      <button onClick={handleSubmit} disabled={isCalculating} className="w-full bg-black text-white py-5 rounded-2xl font-black uppercase tracking-widest disabled:bg-gray-400 shadow-xl active:scale-[0.98] transition-transform">
